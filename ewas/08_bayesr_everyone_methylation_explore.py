...
usual = pd.read_table("/Cluster_Filespace/Marioni_Group/Elena/alcohol_consumption/results/bayesr/usual_drinkers/output/summary/allindividuals_16717_logalcohol_residualized_everyone_meanbeta_pip.tsv", index_col = 1) 
sigma_usual_file = "/Cluster_Filespace/Marioni_Group/Elena/alcohol_consumption/results/bayesr/usual_drinkers/output/sigma/allindividuals_16717_logalcohol_residualized_everyone_processed.csv"
...
varexplained_usual = pd.read_table("/Cluster_Filespace/Marioni_Group/Elena/alcohol_consumption/results/bayesr/usual_drinkers/output/summary/allindividuals_16717_logalcohol_residualized_everyone_varianceexplained.tsv", index_col = 0)
prop_varexplained_usual = pd.read_table("/Cluster_Filespace/Marioni_Group/Elena/alcohol_consumption/results/bayesr/usual_drinkers/output/summary/allindividuals_16717_logalcohol_residualized_everyone_varianceexplained_periteration.tsv")
...
plt.tight_layout()
sns.despine(offset=10, trim=True);
fig.savefig(output_dir + "convergence_alcoholconsumption_everyone_geweke_perparameter.pdf", dpi = 300)
plt.close()
...
ess_df.to_csv(output_dir + "ess_acrosschains_everyone.tsv", sep = "\t", index_label = "Model", na_rep = "NA")
...
sns.despine(offset=10, trim=True);
plt.tight_layout()
fig.savefig(output_dir + "manhattan_alcoholconsumption_everyone.pdf", dpi=300)
plt.close(fig)
...
# Export lists
new_file = open(output_dir + "alcoholconsumption_everyone_genes_0.6.txt", "w")
new_file.write("\n".join(usual_genes))
new_file.close()