...
## Thin out betas
beta_everyone <- fread("beta/allindividuals_16717_logalcohol_residualized_everyone.csv", sep = ",")
...
fwrite(beta_everyone, "beta/allindividuals_16717_logalcohol_residualized_everyone_processed.csv", sep = ",", row.names = F, col.names = F)

## Thin out comp
comp_everyone <- fread("comp/allindividuals_16717_logalcohol_residualized_everyone.csv", sep = ",")
...
fwrite(comp_everyone, "comp/allindividuals_16717_logalcohol_residualized_everyone_processed.csv", sep = ",", row.names = F, col.names = F)

## Thin out sigma
sigma_everyone <- fread("sigma/allindividuals_16717_logalcohol_residualized_everyone.csv", sep = ",")
...
fwrite(sigma_everyone, "sigma/allindividuals_16717_logalcohol_residualized_everyone_processed.csv", sep = ",", row.names = F, col.names = F)
...
setwd("/Cluster_Filespace/Marioni_Group/Elena/alcohol_consumption/results/bayesr/usual_drinkers/output/")
loop <- list.files("comp/", pattern = "_everyone_processed.csv")
